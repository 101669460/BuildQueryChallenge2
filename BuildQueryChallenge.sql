...
WHERE table_name = 'QUERY'; /* CHECK THAT THE NUMBER OF CLUMNS LINES UP WITH THE NUMBER NEEDED */
/*QUERY 2 TEST */
SELECT EVENTMONTH, TOURNAME FROM BOOKING /* CHECK TO SEE IF THE TOTALS LINE UP */
SELECT COUNT(*) FROM BOOKING /* MAKE SURE TOTAL OF TOTALS LINES UP WITH NUMBER OF ROWS IN BOOKING*/

/*QUERY 3 TEST*/
SELECT AVG(PAYMENT) FROM BOOKING /*CHECK THE AVERAGE TO MAKE SURE ONLY BOOKINGS MAD WITH PAYMENTS ABOVE AVERAE ARE COUNTED*/